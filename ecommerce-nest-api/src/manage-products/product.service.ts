...
export class ProductService {
  ...
  async getSeedData(): Promise<ProductEntity[]> {
    //first, need to insert all the seed data into the database
    const seedProducts = [
      {
    ...
    const seedProductEntities = this.productRepository.create(seedProducts);
